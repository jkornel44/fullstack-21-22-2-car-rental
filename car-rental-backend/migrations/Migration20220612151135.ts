...
export class Migration20220612151135 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `car` (`id` integer not null primary key autoincrement, `name` varchar null, `registration_plate` varchar not null, `color` varchar not null, `price` integer not null, `purchase_date` datetime not null);');
