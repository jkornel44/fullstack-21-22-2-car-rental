...
export class Migration20220613011909 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `category` (`id` integer not null primary key autoincrement, `name` varchar not null, `description` varchar null);');
    this.addSql('create unique index `category_name_unique` on `category` (`name`);');

    this.addSql('create table `car` (`id` integer not null primary key autoincrement, `name` varchar null, `registration_plate` varchar not null, `color` varchar not null, `image` varchar not null, `price` integer not null, `purchase_date` datetime not null);');
